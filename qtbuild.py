...
# Form implementation generated from reading ui file 'qtbuild.ui'
#
...
class Ui_MainWindow(QtWidgets.QMainWindow):
    ...
    def setupUi(self, MainWindow):
        ...
        self.textBrowser.setGeometry(QtCore.QRect(0, 90, 241, 461))
        self.textBrowser.setObjectName("textBrowser")
        self.textBrowser_2 = QtWidgets.QTextBrowser(self.centralwidget)
        self.textBrowser_2.setGeometry(QtCore.QRect(250, 90, 291, 461))
        self.textBrowser_2.setObjectName("textBrowser_2")
        self.textBrowser_3 = QtWidgets.QTextBrowser(self.centralwidget)
        self.textBrowser_3.setGeometry(QtCore.QRect(550, 90, 241, 461))
        ...
        self.splitter.setGeometry(QtCore.QRect(0, 50, 791, 31))
        self.splitter.setOrientation(QtCore.Qt.Horizontal)
        self.splitter.setObjectName("splitter")
        self.nodeVol = QtWidgets.QPushButton(self.splitter)
        ...
        self.inR = QtWidgets.QPushButton(self.splitter)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.inR.setText(_translate("MainWindow", "输入电阻"))
        ...
        self.inR.clicked.connect(self.inRf)
    ...
    def nvm(self):
        ...
        # 自导行相加，互导取负
        for i in range(0, n):
            for hh, nb in enumerate(ap[i]):
                ap[i][hh] *= -1
            ap[i][i - rf - 1] = sum(ap[i])
            ap[i][i - rf - 1] *= -1
